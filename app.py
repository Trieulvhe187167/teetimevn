...
def create_app():
    ...
    app.config.setdefault('VNPAY_TMN_CODE', os.environ.get('VNPAY_TMN_CODE', '7S0Z2SB4'))
    app.config.setdefault('VNPAY_HASH_SECRET', os.environ.get('VNPAY_HASH_SECRET', '9S2AT8VYVTUSB1I0GRJSG59MEAZ7FI4X'))
